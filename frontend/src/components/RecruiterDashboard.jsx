...
const StatCard = ({ icon, title, value, trend, delay = 0, to }) => (
  <motion.div
      ...
      <Grid container spacing={3} sx={{ mb: 4 }}>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <StatCard
            ...
            trend="+12% this month"
            delay={0.2}
            to="/recruiter/jobs?status=active"
          />
        </Grid>
                  ...
                  <Table size="small">
                    ...
                    <TableBody>
                      {applications.map((application) => {
                        const candidateLink = application.candidateId?._id ? `/profile/${application.candidateId._id}` : undefined;
                        const jobLink = application.jobId?._id ? `/jobs/${application.jobId._id}` : undefined;
                        return (
                          <TableRow key={application._id} sx={{
                            ...
                            <TableCell sx={{ borderBottom: '1px solid rgba(0, 255, 136, 0.1)' }}>
                              <Typography
                                component={candidateLink ? RouterLink : 'span'}
                                to={candidateLink}
                                variant="subtitle2"
                                sx={{
                                  color: '#ffffff',
                                  fontWeight: 600,
                                  textDecoration: 'none',
                                  '&:hover': candidateLink ? { color: '#00ff88' } : undefined
                                }}
                              >
                ...
                <TextField
                  {...register('applicationDeadline', { 
                    ...
                    validate: (value) => {
                      ...
                      return selectedDate > today || 'Application deadline must be after today';
                    }
                  })}
                  fullWidth
