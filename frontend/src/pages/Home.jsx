    ...
    <Box sx={{ m: 0, p: 0 }}>
      ...
      >
        <Container maxWidth="xl" sx={{ position: 'relative', zIndex: 1, px: { xs: 2, sm: 3, md: 4 }, height: '100%' }}>
          <Grid container spacing={{ xs: 3, sm: 4, md: 6 }} alignItems="center" sx={{ minHeight: '100vh', pt: { xs: 2, sm: 3 } }}>
              ...
              >
                ...
                <Typography
                  ...
                  sx={{
                    ...
                    lineHeight: { xs: 1.05, sm: 0.95, md: 0.9 },
      ...
      <Box
        sx={{
          ...
          '&::before': {
            ...
            right: 0,
            bottom: 0,
            background: 'radial-gradient(circle at 30% 50%, rgba(0, 255, 136, 0.12) 0%, transparent 50%), radial-gradient(circle at 70% 50%, rgba(0, 230, 118, 0.1) 0%, transparent 50%)',
            pointerEvents: 'none',
          }
        }}
      >
          ...
          <AnimatedCard>
            ...
            >
              <Box
                sx={{
                  textAlign: 'center',
                  background: 'linear-gradient(135deg, rgba(0, 255, 136, 0.08) 0%, rgba(0, 0, 0, 0.9) 30%, rgba(0, 0, 0, 0.9) 70%, rgba(0, 255, 136, 0.08) 100%)',
                  borderRadius: '24px',
                  border: '2px solid rgba(0, 255, 136, 0.4)',
                  ...
                  overflow: 'hidden',
                  backdropFilter: 'blur(20px)',
                  boxShadow: '0 0 60px rgba(0, 255, 136, 0.15), inset 0 1px 0 rgba(0, 255, 136, 0.1)',
                  '&::before': {
                    content: '""',
                    position: 'absolute',
                    top: 0,
                ...
                <Box sx={{ position: 'relative', zIndex: 1 }}>
                  <Typography 
                    ...
                    sx={{ 
                      ...
                      px: { xs: 1, sm: 0 },
                      textShadow: '0 4px 30px rgba(0, 255, 136, 0.3)',
                    }}
                  >
                  ...
                  <Box sx={{ 
                    ...
                    {benefits.slice(3).map((benefit, index) => (
                      ...
                      >
                        ...
                        >
                          <CheckCircle sx={{ color: '#00ff88', fontSize: { xs: 18, sm: 20, md: 22 } }} />
                          <Typography 
                            variant="body1" 
                            sx={{ 
                              color: 'rgba(255, 255, 255, 0.9)',
