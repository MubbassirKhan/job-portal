...
const JobCard = ({ job, index }) => {
  ...
  return (
    ...
    >
      <Card 
        component={job?._id ? RouterLink : 'div'}
        to={job?._id ? `/jobs/${job._id}` : undefined}
        sx={{ 
          height: '100%', 
          display: 'flex', 
      ...
      >
        ...
        <CardActions sx={{ justifyContent: 'space-between', px: 2, pb: 2, position: 'relative', zIndex: 1 }}>
          ...
          <Button
            component={job?._id ? RouterLink : 'button'}
            to={job?._id ? `/jobs/${job._id}` : undefined}
            size="small"
        ...
        >
          <Box sx={{ textAlign: 'center', mb: { xs: 4, sm: 6 } }}>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 2, mt: 3 }}>
              ...
              >
                {jobs && jobs.length > 0 ? `${jobs.length} jobs found` : 'Loading opportunities...'}
              </Typography>
            </Box>
          </Box>
        </motion.div>
