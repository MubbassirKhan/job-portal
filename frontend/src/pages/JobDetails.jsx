              ...
              >
                ...
                >
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                    <Schedule sx={{ color: '#ff5722', fontSize: 24 }} />
                    <Typography
                      variant="body1"
                      sx={{
                        color: '#ff5722',
                    ...
                    >
                      ⚠️ Application deadline has passed - This job is no longer accepting applications
                    </Typography>
                  </Box>
                </Paper>
              </motion.div>
                ...
                <Box mb={3}>
                  ...
                  <Grid container spacing={{ xs: 1, sm: 2 }} sx={{ mb: 3 }}>
                    <Grid item xs={12} sm={6}>
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, p: 2, background: 'rgba(0, 255, 136, 0.05)' }}>
            ...
            >
              ...
              {job.postedBy && (
                ...
                >
                  ...
                  <Box 
                    component={job.postedBy?._id ? RouterLink : 'div'}
                    to={job.postedBy?._id ? `/profile/${job.postedBy._id}` : undefined}
                    sx={{ 
                      display: 'flex', 
                      alignItems: 'center', 
                      gap: 1, 
                      mb: 2,
                      cursor: job.postedBy?._id ? 'pointer' : 'default',
                      p: 1,
                      ml: -1,
                      borderRadius: '4px',
                  ...
                  >
                    <Person sx={{ color: '#00ff88', fontSize: 20, transition: 'color 0.3s ease' }} />
                    <Typography 
                      variant="body1" 
                      sx={{ 
                        color: '#ffffff',
