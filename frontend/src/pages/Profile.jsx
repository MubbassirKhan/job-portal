              ...
              <CardContent sx={{ p: 3 }}>
                ...
                <Box sx={{ mt: 4, p: 3, backgroundColor: 'rgba(0, 255, 136, 0.05)', borderRadius: 0, border: '1px solid rgba(0, 255, 136, 0.2)' }}>
                  ...
                  <Grid container spacing={2}>
                    ...
                    {!user.profile?.firstName && (
                      <Grid item xs={12} sm={6}>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, p: 2, backgroundColor: 'rgba(0, 255, 136, 0.1)', borderRadius: 0, border: '1px solid rgba(0, 255, 136, 0.3)' }}>
                          <Person sx={{ color: '#00ff88', fontSize: 18 }} />
                          <Typography variant="body2" sx={{ color: '#ffffff' }}>
                    ...
                    {!user.profile?.phone && (
                      <Grid item xs={12} sm={6}>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, p: 2, backgroundColor: 'rgba(0, 255, 136, 0.1)', borderRadius: 0, border: '1px solid rgba(0, 255, 136, 0.3)' }}>
                          <ContactPhone sx={{ color: '#00ff88', fontSize: 18 }} />
                          <Typography variant="body2" sx={{ color: '#ffffff' }}>
                    ...
                    {!user.profile?.location && (
                      <Grid item xs={12} sm={6}>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, p: 2, backgroundColor: 'rgba(0, 255, 136, 0.1)', borderRadius: 0, border: '1px solid rgba(0, 255, 136, 0.3)' }}>
                          <LocationOn sx={{ color: '#00ff88', fontSize: 18 }} />
                          <Typography variant="body2" sx={{ color: '#ffffff' }}>
                    ...
                    {!user.profile?.bio && (
                      <Grid item xs={12}>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, p: 2, backgroundColor: 'rgba(0, 255, 136, 0.1)', borderRadius: 0, border: '1px solid rgba(0, 255, 136, 0.3)' }}>
                          <Edit sx={{ color: '#00ff88', fontSize: 18 }} />
                          <Typography variant="body2" sx={{ color: '#ffffff' }}>
                    ...
                    {(!user.profile?.skillsDetailed || user.profile?.skillsDetailed?.length === 0) && (!user.profile?.skills || user.profile?.skills?.length === 0) && (
                      <Grid item xs={12} sm={6}>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, p: 2, backgroundColor: 'rgba(0, 255, 136, 0.1)', borderRadius: 0, border: '1px solid rgba(0, 255, 136, 0.3)' }}>
                          <Code sx={{ color: '#00ff88', fontSize: 18 }} />
                          <Typography variant="body2" sx={{ color: '#ffffff' }}>
                    ...
                    {(!user.profile?.workExperience || user.profile?.workExperience?.length === 0) && !user.profile?.experience && (
                      <Grid item xs={12} sm={6}>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, p: 2, backgroundColor: 'rgba(0, 255, 136, 0.1)', borderRadius: 0, border: '1px solid rgba(0, 255, 136, 0.3)' }}>
                          <Work sx={{ color: '#00ff88', fontSize: 18 }} />
                          <Typography variant="body2" sx={{ color: '#ffffff' }}>
                    ...
                    {(!user.profile?.educationDetails || user.profile?.educationDetails?.length === 0) && !user.profile?.education && (
                      <Grid item xs={12} sm={6}>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, p: 2, backgroundColor: 'rgba(0, 255, 136, 0.1)', borderRadius: 0, border: '1px solid rgba(0, 255, 136, 0.3)' }}>
                          <School sx={{ color: '#00ff88', fontSize: 18 }} />
                          <Typography variant="body2" sx={{ color: '#ffffff' }}>
                    ...
                    {(!user.profile?.languages || user.profile?.languages?.length === 0) && (
                      <Grid item xs={12} sm={6}>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, p: 2, backgroundColor: 'rgba(0, 255, 136, 0.1)', borderRadius: 0, border: '1px solid rgba(0, 255, 136, 0.3)' }}>
                          <Language sx={{ color: '#00ff88', fontSize: 18 }} />
                          <Typography variant="body2" sx={{ color: '#ffffff' }}>
                    ...
                    {(!user.profile?.certifications || user.profile?.certifications?.length === 0) && (
                      <Grid item xs={12} sm={6}>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, p: 2, backgroundColor: 'rgba(0, 255, 136, 0.1)', borderRadius: 0, border: '1px solid rgba(0, 255, 136, 0.3)' }}>
                          <EmojiEvents sx={{ color: '#00ff88', fontSize: 18 }} />
                          <Typography variant="body2" sx={{ color: '#ffffff' }}>
                    ...
                    {!user.profile?.resumeUrl && (
                      <Grid item xs={12}>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, p: 2, backgroundColor: 'rgba(0, 255, 136, 0.1)', borderRadius: 0, border: '1px solid rgba(0, 255, 136, 0.3)' }}>
                          <CloudUpload sx={{ color: '#00ff88', fontSize: 18 }} />
                          <Typography variant="body2" sx={{ color: '#ffffff' }}>
          ...
          PaperProps={{
            sx: {
              ...
              '&::before': {
                ...
                right: 0,
                height: '3px',
                background: 'linear-gradient(90deg, #00ff88 0%, #ff5252 100%)',
              }
            }
          }}
        >
